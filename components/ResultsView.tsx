...
const ResultsView: React.FC<ResultsViewProps> = ({
  ...
  return (
    <div
      className={`max-w-[1400px] mx-auto px-4 md:px-6 animate-reveal relative ${
        isDirectory ? 'py-2 md:py-4' : 'py-12 md:py-24'
      }`}
    >
      {!isDirectory && (
        <>
          ...
          <div className="max-w-5xl mx-auto mb-10 md:mb-12">
            {onBack && (
              ...
              >
                ...
                <span>{t('results.refine_profile')}</span>
              </button>
            )}
            ...
            <div className="flex items-center gap-4 md:gap-6 mb-6">
              ...
              <h2 className="text-3xl md:text-5xl font-black text-black dark:text-white tracking-tighter leading-[1.5] md:leading-relaxed">
                {t('results.title')}
              </h2>
            </div>
      ...
      {schemes.length > 0 ? (
        ...
        <div className="glass-card rounded-[2rem] md:rounded-[4rem] py-16 md:py-24 px-6 md:px-10 text-center">
          <h3 className="text-2xl md:text-4xl font-black text-black dark:text-white/20 mb-6 md:mb-8 tracking-tighter">
